...
Собрать большую developer-аудиторию вокруг open source набора инструментов
для создания AI-интерфейсов. Проект должен быть полезен без hosted API,
paywall и обязательных внешних сервисов.
